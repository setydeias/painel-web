...
import { isValidEMail, isNumber } from "../../../utilities/Utilities";
...
const PersonBankData = (props) => {
    ...
    const testEmail = () => {
      if (props.customer.text_email_address) {
        if (isValidEMail(props.customer.text_email_address)) {
